...
func createCreateFile(c *ishell.Context, folderName string, schemaName string, tableName string, modelName string, preFieldsForInsert string, modelFieldsForInsert string, queryFields string, creationDateStmt string) {
	////create find.go////
	findFile := []byte("")
