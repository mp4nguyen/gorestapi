...
func createFindByIdFile(c *ishell.Context, folderName string, schemaName string, tableName string, modelName string, outputFields string, queryFields string, columnKey string) {
	////create find.go////
	findFile := []byte("")
