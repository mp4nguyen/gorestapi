...
func Create(inputs Clinics) (noOfRows int64, lastId int64, err error) {
	sqlStr := "INSERT INTO clinics(clinic_id,clinic_name,isEnable,company_id,isBookable,isTelehealth,isCalendar,description,address,suburb_district,ward,postcode,state_province,country,created_by,creation_date,last_updated_by,last_update_date,latitude,longitude) VALUES "
	vals := []interface{}{}
